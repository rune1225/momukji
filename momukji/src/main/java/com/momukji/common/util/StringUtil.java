...
public class StringUtil {
    ...
    public static String lPad(String str, int len, String pad, boolean isTrim) {
    ...
    public static String rPad(String str, int len, String pad, boolean isTrim) {
...
///////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 * @return String encoding result
	 */
	public static String Uencode(String str, String enc) {
		try {
			return new String(URLEncoder.encode(str,enc)).trim();
		} catch (Exception e) {
	 ...
	 * @return String decoding String
	 */
	public static String Udecode(String str, String dec) {
		try {
			return new String(URLDecoder.decode(str,dec)).trim();
		} catch (Exception e) {
			throw new RuntimeException(e.getMessage(), e.getCause());
		}
	}
